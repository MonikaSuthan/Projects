...
public class Student {
    ...
    public void getStudentValue(JTable table,String searchValue){
        String sql = "select * from student where concat(id,name,email)like ? order by id desc";
        try {
            ps = con.prepareStatement(sql);
    ...
    public void update(int id,String sname,String date,String gender,String email,
        ...
        String sql = "update student set name=?,date_of_birth=?,gender=?,"
                + "email=?,phone=?,father_name=?,mother_name=?,address1=?,address2=? where id=?";
        try {
            ps = con.prepareStatement(sql);
            ...
            if(ps.executeUpdate()>0){       // determines number of rows affected
    ...
    public void delete(int id){
        int YesorNo = JOptionPane.showConfirmDialog(null, "All the details will be deleted permanently",
